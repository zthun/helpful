...
describe("ZEmailEnvelopeBuilder.", () => {
  ...
  beforeEach(() => {
    ...
    psylocke = new ZEmailContactBuilder()
      .address("psylocke@marvel.com")
      .display("Psylocke")
      .build();
  });
  ...
  describe("Properties", () => {
    it("should set the from field as a contact.", () => {
      const expected = new ZEmailContactBuilder()
    ...
    it("should add a to field.", () => {
      ...
      expect(createTestTarget().to(gambit).to(psylocke).build().to).toEqual(
        expected,
      );
    });
    ...
    it("should add a cc field.", () => {
      const expected = [gambit, psylocke];
      expect(createTestTarget().cc(gambit).cc(psylocke).build().cc).toEqual(
        expected,
      );
    });
    ...
    it("should add a bcc field.", () => {
      const expected = [gambit, psylocke];
      expect(createTestTarget().bcc(gambit).bcc(psylocke).build().bcc).toEqual(
        expected,
      );
    });
