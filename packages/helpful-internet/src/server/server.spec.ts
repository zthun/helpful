...
describe("ZServerBuilder.", () => {
  ...
  describe("Properties", () => {
    it("should set the address.", () => {
      ...
      expect(createTestTarget().address(expected).build().address).toEqual(
        expected,
      );
    });
    ...
    it("should set the username.", () => {
      ...
      expect(createTestTarget().username(expected).build().username).toEqual(
        expected,
      );
    });
    ...
    it("should set the password.", () => {
      ...
      expect(createTestTarget().password(expected).build().password).toEqual(
        expected,
      );
    });
  });
